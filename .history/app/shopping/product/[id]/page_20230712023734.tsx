      ...
      <div>
        ...
        <div  className="flex flex-col lg:flex-row  mt-5"   >
          <div>
            ...
            <img src={productPage.content?.images?.full_size[0]} alt="" className="h-100 w-100 border rounded-xl object-contain" />
            <div>
              {productPage.content?.images?.full_size.slice(2, 3).map((image) => (
