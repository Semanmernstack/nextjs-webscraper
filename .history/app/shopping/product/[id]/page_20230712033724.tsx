      ...
      <div>
        ...
        <div  className="flex gap-4 flex-col lg:flex-row  mt-5 p-5"   >
          <div>
            ...
            <img src={productPage.content?.images?.full_size[0]} alt="" className=" w-[400px] border  h-[400px] md:w-[500px] md:h-[350px] lg:w-[786px] lg:h-[400px] rounded-xl object-contain" />
